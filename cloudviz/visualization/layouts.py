...
class BaseLayout(ABC, LoggerMixin):
    ...
    def arrange_resources(
        self, resources: List[CloudResource], relationships: List[ResourceRelationship]
    ...
    def get_graphviz_attributes(self) -> Dict[str, str]:
        ...
        return {"rankdir": "TB", "nodesep": "0.5", "ranksep": "0.5"}
...
class HierarchicalLayout(BaseLayout):
    ...
    def layout_config(self) -> LayoutConfig:
        ...
        return LayoutConfig(
            ...
            parameters={
                ...
                "group_by_resource_group": self.config.get(
    ...
    def _arrange_group_hierarchically(
        ...
        sorted_resources = sorted(
            resources, key=lambda r: (levels.get(r.id, 0), r.get_category(), r.name)
        )
...
class CircularLayout(BaseLayout):
    ...
    def _assign_to_circles(
        self, center: str, connections: Dict[str, List[str]]
    ) -> Dict[int, List[str]]:
    ...
    def _arrange_circle(
        self, resources: List[str], circle_index: int, total_in_circle: int
    ) -> Dict[str, Dict[str, Any]]:
        ...
        for i, resource_id in enumerate(resources):
            ...
            arrangement[resource_id] = {
                ...
                "angle": angle,
                "x": radius
                * (1 if circle_index == 0 else __import__("math").cos(angle)),
                "y": radius
                * (0 if circle_index == 0 else __import__("math").sin(angle)),
            }
    ...
    def get_graphviz_attributes(self) -> Dict[str, str]:
        ...
        return {"layout": "circo", "overlap": "false", "splines": "curved"}
...
class GridLayout(BaseLayout):
    ...
    def _arrange_group_in_grid(
        self, resources: List[CloudResource], start_row: int
    ) -> Dict[str, Dict[str, Any]]:
...
class RadialLayout(BaseLayout):
    ...
    def _arrange_group_radially(
        self, resources: List[CloudResource], start_angle: float, angle_span: float
    ) -> Dict[str, Dict[str, Any]]:
    ...
    def get_graphviz_attributes(self) -> Dict[str, str]:
        ...
        return {"layout": "twopi", "overlap": "false", "splines": "curved"}
