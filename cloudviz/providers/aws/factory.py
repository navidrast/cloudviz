...
from .models import AWS_RESOURCE_TYPES, AWSResource
...
class AWSResourceFactory(BaseResourceFactory):
    ...
    def create_resource(self, resource_type: str, data: Dict[str, Any]) -> AWSResource:
        ...
        try:
            ...
            logger.error(
                "Failed to create AWS resource of type %s: %s", resource_type, str(e)
            )
            raise
    ...
    def validate_resource_data(self, resource_type: str, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.warning(
                "AWS resource data validation failed for type %s: %s",
                resource_type,
                str(e),
            )
            return False
