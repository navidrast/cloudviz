...
from .models import GCPResource, GCP_RESOURCE_TYPES
...
class GCPResourceFactory(BaseResourceFactory):
    ...
    def create_resource(self, resource_type: str, data: Dict[str, Any]) -> GCPResource:
        ...
        try:
            ...
            logger.error("Failed to create GCP resource of type %s: %s", resource_type, str(e))
            raise
    ...
    def validate_resource_data(self, resource_type: str, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.warning("GCP resource data validation failed for type %s: %s", resource_type, str(e))
            return False
